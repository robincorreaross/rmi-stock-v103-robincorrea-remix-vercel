  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        scanner: "bg-gradient-primary text-primary-foreground hover:shadow-primary border-2 border-primary-glow/20 shadow-primary active:scale-95 transition-bounce",
        quantity: "bg-accent text-accent-foreground hover:bg-accent/90 shadow-accent active:scale-95 transition-bounce",
        export: "bg-gradient-accent text-accent-foreground hover:shadow-accent border-2 border-accent-glow/20 shadow-accent",
